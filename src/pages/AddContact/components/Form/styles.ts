...
const TextInput = getStyled<HTMLAttributes<HTMLInputElement>>('input', baseInputStyles);
...
const AddContactButton = getStyled<HTMLAttributes<HTMLButtonElement>>('button', {
  ...formChildrenStyles,
  color: '$white',
  fontWeight: '$bold',
  marginTop: 8,
...
export { FormContainer, TextInput, SelectInput, SelectOption, AddContactButton };	